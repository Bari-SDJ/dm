...
// Returns the public 'Eccube\Controller\Mypage\QuotationController' shared autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/Mypage/QuotationController.php';

$this->services['Eccube\\Controller\\Mypage\\QuotationController'] = $instance = new \Eccube\Controller\Mypage\QuotationController(($this->privates['Eccube\\Repository\\BaseInfoRepository'] ?? $this->getBaseInfoRepositoryService()), ($this->privates['Eccube\\Repository\\CustomerAddressRepository'] ?? $this->load('getCustomerAddressRepositoryService.php')));
