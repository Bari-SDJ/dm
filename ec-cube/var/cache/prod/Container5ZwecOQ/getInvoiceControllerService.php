...
// Returns the public 'Eccube\Controller\Mypage\InvoiceController' shared autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/Mypage/InvoiceController.php';

$this->services['Eccube\\Controller\\Mypage\\InvoiceController'] = $instance = new \Eccube\Controller\Mypage\InvoiceController(($this->privates['Eccube\\Repository\\BaseInfoRepository'] ?? $this->getBaseInfoRepositoryService()), ($this->privates['Eccube\\Repository\\CustomerAddressRepository'] ?? $this->load('getCustomerAddressRepositoryService.php')));
