...
// Returns the public 'Eccube\Controller\Mypage\ContractController' shared autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/Mypage/ContractController.php';

$this->services['Eccube\\Controller\\Mypage\\ContractController'] = $instance = new \Eccube\Controller\Mypage\ContractController(($this->privates['Eccube\\Repository\\BaseInfoRepository'] ?? $this->getBaseInfoRepositoryService()), ($this->privates['Eccube\\Repository\\CustomerAddressRepository'] ?? $this->load('getCustomerAddressRepositoryService.php')));
