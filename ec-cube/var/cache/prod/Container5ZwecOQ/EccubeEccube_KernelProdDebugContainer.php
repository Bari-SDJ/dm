 ...
 * @final
 */
class EccubeEccube_KernelProdDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Eccube\\Controller\\Mypage\\ContractController' => 'getContractControllerService.php',
            'Eccube\\Controller\\Mypage\\DeliveryController' => 'getDeliveryController2Service.php',
            'Eccube\\Controller\\Mypage\\DmtemplateController' => 'getDmtemplateControllerService.php',
            'Eccube\\Controller\\Mypage\\InvoiceController' => 'getInvoiceControllerService.php',
            'Eccube\\Controller\\Mypage\\MypageController' => 'getMypageControllerService.php',
            'Eccube\\Controller\\Mypage\\PriceboardController' => 'getPriceboardControllerService.php',
            'Eccube\\Controller\\Mypage\\QuotationController' => 'getQuotationControllerService.php',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Symfony\Component\Cache\DoctrineProvider(($this->privates['doctrine.app_cache_pool'] ?? $this->getDoctrine_AppCachePoolService()));

        $b->setCacheLogger($c);
        $b->setCacheFactory(new \Doctrine\ORM\Cache\DefaultCacheFactory($d, $e));
        ...
        $i = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Api/Entity')]);
        $i->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $j = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Coupon4/Entity')]);
        $j->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $k = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/MailMagazine4/Entity')]);
        $k->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $l = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/ProductReview4/Entity')]);
        $l->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $m = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Recommend4/Entity')]);
        $m->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $n = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/RelatedProduct4/Entity')]);
        $n->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $o = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Securitychecker4/Entity')]);
        $o->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $p = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($g, [0 => (\dirname(__DIR__, 4).'/app/Plugin/SiteKit/Entity')]);
        $p->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));

        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator([(\dirname(__DIR__, 4).'/vendor/trikoder/oauth2-bundle/Resources/config/doctrine/model') => 'Trikoder\\Bundle\\OAuth2Bundle\\Model'], '.orm.xml')), 'Trikoder\\Bundle\\OAuth2Bundle\\Model');
        ...
        $f->addDriver($i, 'Plugin\\Api\\Entity');
        $f->addDriver($j, 'Plugin\\Coupon4\\Entity');
        $f->addDriver($k, 'Plugin\\MailMagazine4\\Entity');
        $f->addDriver($l, 'Plugin\\ProductReview4\\Entity');
        $f->addDriver($m, 'Plugin\\Recommend4\\Entity');
        $f->addDriver($n, 'Plugin\\RelatedProduct4\\Entity');
        $f->addDriver($o, 'Plugin\\Securitychecker4\\Entity');
        $f->addDriver($p, 'Plugin\\SiteKit\\Entity');
    ...
    protected function getTwigService()
    {
        ...
        $i = new \SunCat\MobileDetectBundle\Twig\Extension\MobileDetectExtension(($this->privates['mobile_detect.mobile_detector.default'] ?? ($this->privates['mobile_detect.mobile_detector.default'] = new \SunCat\MobileDetectBundle\DeviceDetector\MobileDetector())), ($this->privates['mobile_detect.device_view'] ?? $this->getMobileDetect_DeviceViewService()), $this->parameters['mobile_detect.redirect']);
        $i->setRequestByRequestStack($e);
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kGH6+0M9tK', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDebug_Security_FirewallService()
    {
        return $this->privates['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            yield 'security.firewall.map.context.admin' => ($this->privates['.security.request_matcher.v4NLfLd'] ?? ($this->privates['.security.request_matcher.v4NLfLd'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/')));
    ...
    {
        $this->privates['doctrine.app_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('sV0CqDMer9', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/EccubeEccube_KernelProdDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'EccubeEccube_KernelProdDebugContainer',
            ...
            'router.cache_class_prefix' => 'EccubeEccube_KernelProdDebugContainer',
