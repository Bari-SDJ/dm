...
// Returns the public 'Eccube\Controller\Mypage\PriceboardController' shared autowired service.
...
include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/Mypage/PriceboardController.php';

$this->services['Eccube\\Controller\\Mypage\\PriceboardController'] = $instance = new \Eccube\Controller\Mypage\PriceboardController(($this->privates['Eccube\\Repository\\BaseInfoRepository'] ?? $this->getBaseInfoRepositoryService()), ($this->privates['Eccube\\Repository\\CustomerAddressRepository'] ?? $this->load('getCustomerAddressRepositoryService.php')));
