...
class __TwigTemplate_3227959c443df869cf3c3b66a075e9e74adcfd4500be07cad158fff36c19b67c extends \Eccube\Twig\Template
{
    private $source;
    private $macros = [];
...
{% macro form_tree_details(name, data, forms_by_hash, show) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/form.html.twig", "/Applications/MAMP/htdocs/eccube-mylocal/ec-cube/vendor/symfony/web-profiler-bundle/Resources/views/Collector/form.html.twig");
    }
}
