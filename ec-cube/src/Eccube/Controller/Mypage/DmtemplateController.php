...
class DmtemplateController extends AbstractController
{
    /**
     * @var BaseInfo
     */
     ...
     * お届け先一覧画面.
     *
     * @Route("/mypage/dmtemplate", name="mypage_dmtemplate", methods={"GET"})
     * @Template("Mypage/dmtemplate.twig")
     */
     ...
     * お届け先編集画面.
     *
     * @Route("/mypage/dmtemplate/new", name="mypage_dmtemplate_new", methods={"GET", "POST"})
     * @Route("/mypage/dmtemplate/{id}/edit", name="mypage_dmtemplate_edit", requirements={"id" = "\d+"}, methods={"GET", "POST"})
     * @Template("Mypage/dmtemplate_edit.twig")
     */
    public function edit(Request $request, $id = null)
    {
        ...
        // 正しい遷移かをチェック
        $allowedParents = [
            $this->generateUrl('mypage_dmtemplate'),
        ...
        if (!in_array($parentPage, $allowedParents)) {
            ...
            $parentPage = $this->generateUrl('mypage_dmtemplate');
        }
        ...
        $this->eventDispatcher->dispatch(EccubeEvents::FRONT_MYPAGE_DMTEMPLATE_EDIT_INITIALIZE, $event);
        ...
        if ($form->isSubmitted() ){// && $form->isValid()) {
            ...
            $this->eventDispatcher->dispatch(EccubeEvents::FRONT_MYPAGE_DMTEMPLATE_EDIT_COMPLETE, $event);
 
            return $this->redirect($this->generateUrl('mypage_dmtemplate'));
     ...
     * お届け先を削除する.
     *
     * @Route("/mypage/dmtemplate/{id}/delete", name="mypage_dmtemplate_delete", methods={"DELETE"})
     */
    public function delete(Request $request, CustomerAddress $CustomerAddress)
    {
        ...
        $this->eventDispatcher->dispatch(EccubeEvents::FRONT_MYPAGE_DMTEMPLATE_DELETE_COMPLETE, $event);
...
//exit();
     ...
     * お届け先を削除する.
     *
     * @Route("/mypage/dmtemplate/upload", name="mypage_dmtemplate_upload", methods={"GET", "POST"})
     * @Template("Mypage/dmtemplate_upload.twig")
     */
    public function upload(Request $request): JsonResponse
    {
        ...
        $uploadDir = $this->getParameter('/eccube-mylocal/ec-cube/html/upload/dmtemplate/bm');
