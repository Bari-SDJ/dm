...
final class EccubeEvents
{
    ...
    /**
     * Mypage/QuotationController
     */
    // edit
    const FRONT_MYPAGE_QUOTATION_EDIT_INITIALIZE = 'front.mypage.quotation.edit.initialize';
    const FRONT_MYPAGE_QUOTATION_EDIT_COMPLETE = 'front.mypage.quotation.edit.complete';
   // delete
   const FRONT_MYPAGE_QUOTATION_DELETE_COMPLETE = 'front.mypage.delete.complete';

    /**
     * Mypage/InvoiceController
     */
    // edit
    const FRONT_MYPAGE_INVOICE_EDIT_INITIALIZE = 'front.mypage.invoice.edit.initialize';
    const FRONT_MYPAGE_INVOICE_EDIT_COMPLETE = 'front.mypage.invoice.edit.complete';
   // delete
   const FRONT_MYPAGE_INVOICE_DELETE_COMPLETE = 'front.mypage.delete.complete';

    /**
     * Mypage/ContractController
     */
    // edit
    const FRONT_MYPAGE_CONTRACT_EDIT_INITIALIZE = 'front.mypage.contract.edit.initialize';
    const FRONT_MYPAGE_CONTRACT_EDIT_COMPLETE = 'front.mypage.contract.edit.complete';
   // delete
   const FRONT_MYPAGE_CONTRACT_DELETE_COMPLETE = 'front.mypage.delete.complete';

    /**
     * Mypage/PriceboardController
     */
    // edit
    const FRONT_MYPAGE_PRICEBOARD_EDIT_INITIALIZE = 'front.mypage.priceboard.edit.initialize';
    const FRONT_MYPAGE_PRICEBOARD_EDIT_COMPLETE = 'front.mypage.priceboard.edit.complete';
   // delete
   const FRONT_MYPAGE_PRICEBOARD_DELETE_COMPLETE = 'front.mypage.delete.complete';

    /**
     * Mypage/DmtemplateController
     */
    // edit
    const FRONT_MYPAGE_DMTEMPLATE_EDIT_INITIALIZE = 'front.mypage.dmtemplate.edit.initialize';
    const FRONT_MYPAGE_DMTEMPLATE_EDIT_COMPLETE = 'front.mypage.dmtemplate.edit.complete';
