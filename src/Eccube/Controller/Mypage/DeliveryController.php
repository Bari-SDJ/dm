...
///=======================================fetch task start ============================
        ...
        $htmlContent = '
            <html>
                <body>
                    <h1>Welcome to EC-CUBE!</h1>
                    <p id="greeting">Hello, World!</p>
                </body>
            </html>
        ';
$url = 'https://www.goo-net.com/usedcar/spread/goo/13/700056156230241024002.html';
...
//exit();
        ...
        //$greetingNode = $xpath->query('/input[@id="seat_aircon"]');
        ////*[@id="seat_aircon"]
        ///html/body/div[1]/div[1]/div[3]/form[2]/div/div[3]/table[1]/tbody/tr[1]/td[1]
        //var_dump($greetingNode->nodeValue);


//*[@id="specDataBox"]/table[1]/tbody/tr[1]/td[1]

        //if ($greetingNode) {
        //    $greetingNode->nodeValue = 'Hello, EC-CUBE User!';
        //}

        // Save the modified HTML
        //$modifiedHtml = $dom->saveHTML();

        // Render or return the modified HTML content
...
///=======================================fetch task end ============================
     ...
     */
    public function edit(Request $request, $id = null, $sitvalue = null)
    {
        ...
        if ($form->isSubmitted()  && $form->isValid()) {
            ...
            $bm = $request->request->get('sitvalue');
            var_dump("bmmmmmmmmmmmmmmmm: edit". $bm);//exit();
        ...
        var_dump("bmmmmmmmmmmmmmmmm: edit". $request->request->get('username'));//exit();
