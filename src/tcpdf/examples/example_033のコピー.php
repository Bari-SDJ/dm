...
body { margin-left: 0.59055118110236in; margin-right: 0.59055118110236in; margin-top: 0.59055118110236in; margin-bottom: 0.59055118110236in; }
    ...
    <table border="0" cellpadding="0" cellspacing="0" id="sheet0" class="sheet0">
        ...
        <tbody>
          ...
          <tr class="row1">
            <td class="column0">&nbsp;</td>
            <td class="column1 style42 s style43" colspan="2">{$_POST['1_1']}</td>
...
本店：TEL 0473675107   FAX 047-362-7425</td>
          ...
          <tr class="row4">
            ...
            <td class="column27 style31 f style15" colspan="5">{$_POST['1_3']}</td>
          ...
          <tr class="row5">
            ...
            <td class="column19 style38 s style15" colspan="13">{$_POST['1_4']}</td>
          ...
          <tr class="row6">
            ...
            <td class="column19 style38 s style15" colspan="13">{$_POST['1_6']}</td>
            <td class="column37 style2 null"></td>
...
//$upload_path = rtrim($_SERVER['SCRIPT_NAME'],basename($_SERVER['SCRIPT_NAME']));
...
$pdf->MultiCell(80, 0, "ども[CID-0 font] : Cras eros leo, porttitor porta, accumsan fermentum, ornare ac, est. Praesent dui lorem, imperdiet at, cursus sed, facilisis aliquam, nibh. Nulla accumsan nonummy diam. Donec tempus. Etiam posuere. Proin lectus. Donec purus. Duis in sem pretium urna feugiat vehicula. Ut suscipit velit eget massa. Nam nonummy, enim commodo euismod placerat, tortor elit tempus lectus, quis suscipit metus lorem blandit turpis.\n", 1, 'J', 0, 1, '', '', true, 0);


$html = file_get_contents('test.php', false);
$pdf->Write(5, $html, '', 0, '', false, 0, false, false, 0);
...
//$pdf->Output($_SERVER['DOCUMENT_ROOT'] . '/eccube-mylocal/ec-cube/html/upload/quotation/example_033.pdf', 'ID');

$pdf->Output('example_033.pdf', 'ID');

//$pdf_string = $pdf->Output('pseudo.pdf', 'S');
//file_put_contents('/Users/Bari2/Downloads/output/myfile.pdf', $pdf_string);
//============================================================+
// END OF FILE
//============================================================+
//$pdf->redirect('/eccube-mylocal/ec-cube/index.php/mypage/quotation');